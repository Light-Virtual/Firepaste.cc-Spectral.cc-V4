...
void resolver::resolve_yaw()
{
	...
	if (!animstate || !desync_detect() || !shot_resolver() || !g_cfg.ragebot.desync_correction)
	{
		player_record->side = RESOLVER_ORIGINAL;
		return;
	}
	...
	/*auto roll_first_side = low_delta ? naxui : RESOLVER_FIRST;
	auto roll_second_side = low_delta ? roll?? : RESOLVER_SECOND;*/
