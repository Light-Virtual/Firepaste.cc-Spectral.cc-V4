...
void misc::watermark()
{
	...
	ImGui::Begin("##", nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoBackground | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_::ImGuiWindowFlags_NoBringToFrontOnFocus | ImGuiWindowFlags_::ImGuiWindowFlags_NoBackground | ImGuiWindowFlags_::ImGuiWindowFlags_NoNavFocus | ImGuiWindowFlags_::ImGuiWindowFlags_NoNav);
	{
		...
		draw->AddText(ImVec2(p.x + 140, p.y + 5), ImColor(100, 125, 200), ms.c_str());
...
void misc::ChatSpammer()
{
	...
	{
		crypt_str("FirePaste.cc - worst cheat for the game."),
		crypt_str("Get bad. Get FirePaste.cc."),
		crypt_str("FirePaste.cc - worst than its competitors."),
		crypt_str("Go to the baddest level with FirePaste.cc"),
	};
