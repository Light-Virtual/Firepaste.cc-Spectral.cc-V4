...
namespace util
{
	...
	{
		static auto cl_ud_rate = m_cvar()->FindVar(crypt_str("cl_updaterate"));
		static auto min_ud_rate = m_cvar()->FindVar(crypt_str("sv_minupdaterate"));
		static auto max_ud_rate = m_cvar()->FindVar(crypt_str("sv_maxupdaterate"));
		...
		static auto c_min_ratio = m_cvar()->FindVar(crypt_str("sv_client_min_interp_ratio"));
		static auto c_max_ratio = m_cvar()->FindVar(crypt_str("sv_client_max_interp_ratio"));

		float lerp = m_globals()->m_intervalpertick;
