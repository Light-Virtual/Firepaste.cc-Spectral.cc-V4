...
namespace ImGui
{
    ...
    IMGUI_API bool          ColorEdit(const char* label, Color* newcolor, ImGuiColorEditFlags flags = 0, bool scripts = false, bool double_color = false);
    ...
    IMGUI_API bool          weapon(const char* label, bool selected, float sizex, int cout, bool reverse);
    IMGUI_API bool          sub_tab(const char* icon, const char* label, bool selected);
